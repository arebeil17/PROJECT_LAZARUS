...
#set_property PACKAGE_PIN T1 [get_ports {In[0]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {In[0]}]
##Bank = 34, Pin name = IO_L11P_T1_SRCC_34,					Sch name = SW13
#set_property PACKAGE_PIN R3 [get_ports {In[1]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {In[1]}]
##Bank = 34, Pin name = IO_L14N_T2_SRCC_34,					Sch name = SW14
#set_property PACKAGE_PIN P3 [get_ports {Lvl_Sel[0]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {Lvl_Sel[0]}]
##Bank = 34, Pin name = IO_L14P_T2_SRCC_34,					Sch name = SW15
#set_property PACKAGE_PIN P4 [get_ports {Lvl_Sel[1]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {Lvl_Sel[1]}]
...
set_property PACKAGE_PIN V4 [get_ports {ClkOut}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ClkOut}]
##Bank = 34, Pin name = IO_L8N_T1_34,						Sch name = LED9
#set_property PACKAGE_PIN U3 [get_ports {GameOver}]					
...
#set_property PACKAGE_PIN P5 [get_ports {Level_Cnt[0]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {Level_Cnt[0]}]
##Bank = 34, Pin name = IO_L7P_T1_34,						Sch name = LED13
#set_property PACKAGE_PIN U1 [get_ports {Level_Cnt[1]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {Level_Cnt[1]}]
##Bank = 34, Pin name = IO_L15N_T2_DQS_34,					Sch name = LED14
#set_property PACKAGE_PIN R2 [get_ports {Level_Cnt[2]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {Level_Cnt[2]}]
##Bank = 34, Pin name = IO_L15P_T2_DQS_34,					Sch name = LED15
#set_property PACKAGE_PIN P2 [get_ports {Level_Cnt[3]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {Level_Cnt[3]}]
...
#set_property PACKAGE_PIN E16 [get_ports Begin]						
...
#set_property PACKAGE_PIN R10 [get_ports Play_2]						
#	set_property IOSTANDARD LVCMOS33 [get_ports Play_2]
##Bank = 14, Pin name = IO_L21P_T3_DQS_14,					Sch name = BTND
#set_property PACKAGE_PIN V10 [get_ports Play_1]						
#	set_property IOSTANDARD LVCMOS33 [get_ports Play_1]
